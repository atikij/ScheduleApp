...
namespace WebApplication1.Controllers
{
    ...
    [ApiController]
    public class CabinetScheduleController : ControllerBase
    {
        private readonly mydbContext _context;

        public CabinetScheduleController(mydbContext context)
        {
            _context = context;
        }

        [HttpGet]
        public async Task<ActionResult<IEnumerable<PairDto>>> GetCabinetSchedules()
        {
